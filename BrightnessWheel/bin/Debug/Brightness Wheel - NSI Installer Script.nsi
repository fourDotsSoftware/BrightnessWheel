...
;copy translations end
  ...
  !define MUI_FILE "BrightnessWheel"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Brightness Wheel"
  !define PRODUCT_SHORTCUT "Brightness Wheel"
  !define PRODUCT_VERSION "1.1"
  
  !define MUI_ICON "brightness-wheel-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Brightness Wheel"
  OutFile "BrightnessWheelSetup.exe"

  InstallDir "$PROGRAMFILES\softpcapps Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\softpcapps Software\Brightness Wheel" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Brightness Wheel - User's Manual.url.lnk" "$INSTDIR\Brightness Wheel - User's Manual.url" "" "$INSTDIR\Brightness Wheel - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\BrightnessWheelShellExtx64.dll $SYSDIR\BrightnessWheelShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\BrightnessWheelShellExt_vs2008_w7_x86.dll $SYSDIR\BrightnessWheelShellExt.dll $SYSDIR
...
;!  inetc::get /SILENT "http://softpcapps.com/installmonetizer/BrightnessWheel.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; Delete  /rebootok $SYSDIR\BrightnessWheelShellExt.dll 
;  File "CryptoObfuscator_Output\${MUI_FILE}.exe"

  File "signedn\${MUI_FILE}.exe"
  File "signedn\BrightnessWheelGet.exe"
  File "signedn\BrightnessWheelSet.exe"
  
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Brightness Wheel - User's Manual.chm";
  File "Brightness Wheel - User's Manual.url";
...
;begin new uninstall strings
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\softpcapps Software\Brightness Wheel" "" $INSTDIR
  WriteRegStr HKLM "Software\softpcapps Software\Brightness Wheel" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\BrightnessWheelShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\softpcapps Software\Brightness Wheel"
  DeleteRegKey HKCU "Software\softpcapps Software\Brightness Wheel"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://softpcapps.com/brightness-wheel/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://softpcapps.com/brightness-wheel/how-to-use.php?afterinstall=true"
FunctionEnd
