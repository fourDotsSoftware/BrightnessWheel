...
namespace BrightnessWheelSet
{
    ...
    public class BrightnessController : IDisposable
    {
        ...
        {
            IntPtr hwndDC = GetDC(IntPtr.Zero);
            IntPtr windowHandle = WindowFromDC(hwndDC);

            //Console.WriteLine(hwndDC.ToInt32().ToString());
            //Console.WriteLine(windowHandle.ToInt32().ToString());

            uint dwFlags = 0u;
            IntPtr ptr = MonitorFromWindow(windowHandle, dwFlags);

            //Console.WriteLine(ptr.ToInt32().ToString());
            ...
            //Console.WriteLine(_physicalMonitorsCount.ToString());
            ...
            //Console.WriteLine(_firstMonitorHandle.ToInt32().ToString());
